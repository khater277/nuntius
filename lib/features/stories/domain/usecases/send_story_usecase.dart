...
class SendStoryUsecase implements BaseUseCase<void, StoryModel> {
  final StoriesRepository storiesRepository;

  SendStoryUsecase({required this.storiesRepository});
  @override
  Future<Either<Failure, void>> call(StoryModel storyModel) {
    return storiesRepository.sendStory(storyModel: storyModel);
  }
}
