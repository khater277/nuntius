...
class SeeMessageUsecase implements BaseUseCase<void, String> {
  final MessagesRepository messagesRepository;

  SeeMessageUsecase({required this.messagesRepository});

  @override
  Future<Either<Failure, void>> call(String phoneNumber) {
    return messagesRepository.seeMessage(phoneNumber: phoneNumber);
  }
}
